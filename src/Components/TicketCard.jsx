...
const TicketCard = ({ ticket, groupingType, sortingType}) => {
  return (
    <div className="ticket-card">
      {/* <p className="ticket-priority">{ticket.id}</p>*/}
      <p className="ticket-priority">
  {ticket.id}
  {groupingType!=='username' && <span className="photo-icon">
    {/* SVG icon for photo */}
    <img src={defaultProfile} alt="" className='card-icon-user'/>
  </span>}
</p>
      ...
      <p className="ticket-user">User: {ticket.username}</p> */}
      {/* <p className="ticket-priority">{ticket.tag}</p> */}
